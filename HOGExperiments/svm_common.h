...
typedef struct svector {
  SVM_WORD    *words;              /* The features/values in the vector by
...
SVECTOR *create_svector(SVM_WORD *, char *, double);
SVECTOR *create_svector_shallow(SVM_WORD *, char *, double);
...
int    parse_document(char *, SVM_WORD *, double *, long *, long *, double *, long *, long, char **);

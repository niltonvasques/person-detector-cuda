										 ...
										 int width, int height)
{
	...
	localValue = MIN(0.2f, localValue); //why 0.2 ??
...
__host__ void FastHOG::InitHistograms(int cellSizeX, int cellSizeY, int blockSizeX, int blockSizeY, int noHistogramBins, float wtscale)
{
	int i, j;
...
__host__ void FastHOG::CloseHistogram()
{
}


__host__ void FastHOG::ComputeBlockHistogramsWithGauss(float2* inputImage, float1* blockHistograms, int noHistogramBins,
											  int cellSizeX, int cellSizeY, int blockSizeX, int blockSizeY,
...
__host__ void FastHOG::NormalizeBlockHistograms(float1* blockHistograms, int noHistogramBins,
									   int cellSizeX, int cellSizeY, int blockSizeX, int blockSizeY,
									   int width, int height)
{
	dim3 hThreadSize, hBlockSize;
